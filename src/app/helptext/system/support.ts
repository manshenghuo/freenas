...
export const helptext_system_support = {
 ...
 Enterprise®, copy the text of the TrueNAS license and paste it in this box.')
  ...
  FN_instructions: T('Search the <a href="https://jira.ixsystems.com/projects/NAS/issues/" \
   target="_blank">NAS issue tracker</a> \
  ...
  FN_Jira_message: T('<a href="https://jira.ixsystems.com/secure/Signup!default.jspa" target="_blank">\
   ...
   docHub: T('<a href="#" target="_blank">\
 NAS Documentation Hub</a> - Read and contribute to the open-source documentation.'),

  forums: T('<a href="#" target="_blank">\
 NAS Forums</a> - Find answers from other users in the forums.'),

  licensing: T('<a href="#" target="_blank">\
 NAS Licensing</a> - Learn more about enterprise-grade support.'),
